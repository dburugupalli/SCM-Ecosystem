...
import Business.Role.SupplyManager;
import Business.Role.WholeSalesManager;
...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Manage Enterprise Admin Area");
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if(enterprise.getEnterpriseType() == WholeSaler ){
            
            UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new WholeSalesManager());
        }
        if(enterprise.getEnterpriseType() == Supplier ){
            
            UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new SupplyManager());
        }
        else{
